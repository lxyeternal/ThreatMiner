...
if __name__ == '__main__':
    ...
    all_source = getcsv()
    end_class, class_user,user_format_class = networkclass()
    class_one_network = onenetwork(all_source,class_user)
    print (all_source)
    print (end_class)
    source_forum_0x00sec_list = class_one_network[0]
    source_forum_hackthissite_list = class_one_network[1]
    source_forum_antionline_list = class_one_network[2]
    source_forum_garage4hackers_list = class_one_network[3]
    source_forum_hacktoday_list = class_one_network[4]
    source_forum_SafeSkyHacks_list = class_one_network[5]

    class_forum_0x00sec_list = user_format_class[0]
    class_forum_hackthissite_list =  user_format_class[1]
    class_forum_antionline_list =  user_format_class[2]
    class_forum_garage4hackers_list =  user_format_class[3]
    class_forum_hacktoday_list =  user_format_class[4]
    class_forum_SafeSkyHacks_list =  user_format_class[5]
