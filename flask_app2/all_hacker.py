...
def getcsv():
    ...
    for k in csv_file_num:
        ...
        num = num + 1
    with open("data/all_source.txt","w") as f:
        f.write(str(all_source))
    return all_source
...
def networkclass():
    ...
    for row in results:
        ...
        try:
            ...
            print ('\n')
            break
    with open("data/end_class.txt","w") as k:
        k.write(str(end_class))
    with open("data/class_forum_0x00sec_list.txt","w") as k1:
        k1.write(str(class_forum_0x00sec_list))
    with open("data/class_forum_hackthissite_list.txt","w") as k2:
        k2.write(str(class_forum_hackthissite_list))
    with open("data/class_forum_antionline_list.txt","w") as k3:
        k3.write(str(class_forum_antionline_list))
    with open("data/class_forum_garage4hackers_list.txt","w") as k4:
        k4.write(str(class_forum_garage4hackers_list))
    with open("data/class_forum_hacktoday_list.txt","w") as k5:
        k5.write(str(class_forum_hacktoday_list))
    with open("data/class_forum_SafeSkyHacks_list.txt","w") as k6:
        k6.write(str(class_forum_SafeSkyHacks_list))
...
def onenetwork(all_source,class_user):
    ...
    with open("data/source_forum_0x00sec_list.txt","w") as f1:
        f1.write(str(source_forum_0x00sec_list))
    with open("data/source_forum_hackthissite_list.txt","w") as f2:
        f2.write(str(source_forum_hackthissite_list))
    with open("data/source_forum_antionline_list.txt","w") as f3:
        f3.write(str(source_forum_antionline_list))
    with open("data/source_forum_garage4hackers_list.txt","w") as f4:
        f4.write(str(source_forum_garage4hackers_list))
    with open("data/source_forum_hacktoday_list.txt","w") as f5:
        f5.write(str(source_forum_hacktoday_list))
    with open("data/source_forum_SafeSkyHacks_list.txt","w") as f6:
        f6.write(str(source_forum_SafeSkyHacks_list))
